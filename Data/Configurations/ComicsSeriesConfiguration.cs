...
{
    internal class ComicsSeriesConfiguration : IEntityTypeConfiguration<ComicsSeries>
    {
        /// <remarks>
        ...
        /// </remarks>
        public virtual void Configure(EntityTypeBuilder<ComicsSeries> builder)
        {
            // Table
            builder.ToTable("ComicsSeries");
            // Keys
